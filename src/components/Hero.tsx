    ...
    <section id="top" className="overflow-hidden bg-bg">
      <div className="mx-auto flex min-h-[78vh] max-w-[1600px] flex-col items-center justify-center px-6 py-20 text-center sm:px-12 sm:py-28">
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
          <a
            href="#work"
            className="rounded-full bg-fg px-7 py-3.5 text-sm font-semibold text-bg transition-transform hover:-translate-y-0.5"
          >
            작업물 보기 ↓
          </a>
          <a
            href="#contact"
            className="rounded-full border-2 border-fg px-7 py-3.5 text-sm font-semibold transition-colors hover:bg-fg hover:text-bg"
          >
            연락하기
          </a>
        </div>
